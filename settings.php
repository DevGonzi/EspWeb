...
if(isset($_GET['save'])) {
	...
	if($save == 'personal_data') {
		...
		if($vorname == "" || $nachname == "") {
			...
			$success_msg = "Daten erfolgreich geändert.";
		}
	} else if($save == 'email') {
		...
		if($email != $email2) {
			...
			$success_msg = "E-Mail-Adresse erfolgreich geändert.";
		}
...
<div>
    	...
    	<form action="?save=email" method="post" class="form-horizontal">
    		<div class="form-group">
    			<label for="inputPasswort" class="col-sm-2 control-label">Aktuelles Passwort</label>
    			<div class="col-sm-10">
    		...
    		<div class="form-group">
    			<label for="inputEmail" class="col-sm-2 control-label">Neue E-Mail</label>
    			<div class="col-sm-10">
    		...
    		<div class="form-group">
    			<label for="inputEmail2" class="col-sm-2 control-label">Neue E-Mail (wiederholen)</label>
    			<div class="col-sm-10">
